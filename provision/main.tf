...
resource "libvirt_volume" "base_volume-20230702-1" {
  name   = "runner-ubuntu-22.04-20230702.1.qcow2"
  source = "/root/ubuntu-22.04-20230702.1"
  format = "qcow2"
  pool   = libvirt_pool.kong.name
}

resource "libvirt_volume" "base_volume-20230806-1" {
