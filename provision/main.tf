...
resource "libvirt_volume" "base_volume-20230507-1" {
  name   = "runner-ubuntu-22.04-20230507.1.qcow2"
  source = "/root/ubuntu-22.04-20230507.1"
  format = "qcow2"
  pool   = libvirt_pool.kong.name
}

resource "libvirt_volume" "base_volume-20230611-1" {
